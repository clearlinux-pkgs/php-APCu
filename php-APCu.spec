...
Source0  : https://pecl.php.net/get/apcu-5.1.24.tgz
...
%prep
%setup -q -n apcu-5.1.24
cd %{_builddir}/apcu-5.1.24
pushd ..
cp -a apcu-5.1.24 buildavx2
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/extensions/no-debug-non-zts-20240924/apcu.so
